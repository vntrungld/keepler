...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-violet-400 text-sm font-medium leading-5 text-white focus:outline-none focus:border-violet-500 transition duration-150 ease-in-out'
